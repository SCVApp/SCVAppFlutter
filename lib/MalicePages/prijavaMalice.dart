...
class MalicePrijavaPage extends StatefulWidget {
  MalicePrijavaPage({Key key}) : super(key: key);

  _MalicePrijavaPageState createState() => _MalicePrijavaPageState();
}

class _MalicePrijavaPageState extends State<MalicePrijavaPage> {
    ...
    logInUser() async {
      ...
      if (username != "" && password != "") {
        ...
        final response = await http.post(
            Uri.parse("https://malice.scv.si/api/v2/auth"),
            body: formData);
        setState(() {
          isLoggingIn = false;
        });
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: TextButton(
                          ...
                          onPressed: () => launchUrl(
                              Uri.parse(
                                  "https://malice.scv.si/students/password/new"),
