...
import 'package:scv_app/pages/Urnik/moreInformations.dart';
...
Widget viewForUra(
  ...
  void showMoreInformations() {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => UrnikMoreInformations(ura, obdobjeUre)));
  }
